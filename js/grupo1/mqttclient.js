...
client.onMessageArrived = function (message) {
	...
	if (destination === "probar_1") {
        ...
        let diffGPU = dataGPU - prevGPUValue;
        ...
        let percentageGPU = calculatePercentage(diffGPU, prevGPUValue);
        ...
        document.getElementById("GPUValue").innerText = dataGPU;
        ...
        document.getElementById("GPUPercentage").innerText = percentageGPU + "%";
